...
export * from './types/dto/id/collection.interface'
...
export * from './types/entities/collection.interface'
...
export * from './types/dto/id/download-record.interface'
export * from './types/entities/download-record.interface'
